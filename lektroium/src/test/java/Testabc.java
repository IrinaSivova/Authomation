   ...
   // private WebElement signInLink;
    ...
    public void start(){
        ChromeDriverService serviceChrome = new ChromeDriverService.Builder()
                .usingDriverExecutable(new File("D:/lektroium/src/main/resources/chromedriver.exe"))
                .usingAnyFreePort()
                .build();
     ...
     //   WebElement assertElement = driver.findElement(By.xpath("(//div[@class='auth-f-i-title'])[1]"));
